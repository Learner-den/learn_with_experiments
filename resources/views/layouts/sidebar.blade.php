<div x-cloak :class="sidebarOpen ? 'block' : 'hidden'" @click="sidebarOpen = false" class="fixed inset-0 z-20 transition-opacity bg-black opacity-50 lg:hidden"></div>
        ...
        <div class="flex items-center">
            <button
                ...
                <img class="object-cover w-full h-full"
                    src="https://www.istockphoto.com/vector/3d-kid-online-school-remote-education-concept-vector-cartoon-sitting-boy-doing-gm1473279288-503447120"
                    alt="Your avatar">
            </button>
                    <span class="mx-2 text-2xl font-semibold text-white">Rehman</span>
        </div>
    </div>
    ...
    <nav class="mt-10">
        ...
        <!-- The :active attribute shall keep this menu/link highlighted  -->
        <!-- when this menu is selected i.e. active -->
