<x-guest-layout>
    <div class="mt-12 max-w-6xl mx-auto">
        ...
        @can('create', App\Models\Post::class)        
            <!-- The 'create' is pointing that we are using create() method defined in PostPolicy -->
            <!-- whereas the, 2nd parameter is the name of Model to which this user can create. -->
