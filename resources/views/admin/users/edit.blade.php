<x-admin-layout>
    ...
    <div class="mt-12 max-w-6xl mx-auto bg-gray-500 p-4 rounded">
                        ...
                        <select name="role_id"
                            ...
                            @foreach ($roles as $role)
                                @if($role->name!='admin')
                                    ...
                                    <!-- loop through all the roles except 'admin' role. So, now in drop down menu -->
                                    <!-- of this user edit form all the roles will appear except the admin role. -->
